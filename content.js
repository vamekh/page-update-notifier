...
var interestedSites = [
    {
        name: 'მაკბუქები',
        page: 'https://www.mymarket.ge/ka/search/?CondTypeID=-1&CatID=53&Brands=42&Attrs=46.3133.3132-47.13.14-48.3071.3242.3072.3377-45.30',
        selector: '.pr-search-list .pr-search-dt .b-16:nth-child(1) span',
        lastValue: '10966437'
    },
    {
        name: 'subaru',
        page: 'https://www.myauto.ge/ka/search/?stype=0&marka=39&model=1043&category_id=m0&year_from=2011&price_to=9000&currency_id=1&right_wheel=2&loc_id=1&det_search=0&ord=1&last_model=1043',
        selector: '.search-lists-container .current-item .car-list-id .cr-vp-lbl',
        lastValue: 'ID 25975788'
    }
];
